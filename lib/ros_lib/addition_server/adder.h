#ifndef _ROS_SERVICE_adder_h
#define _ROS_SERVICE_adder_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"

namespace addition_server
{

static const char ADDER[] = "addition_server/adder";

  class adderRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return ADDER; };
    virtual const char * getMD5() override { return "ef8322123148e475e3e93a1f609b2f70"; };

  };

  class adderResponse : public ros::Msg
  {
    public:
  ...
  class adder {
    public:
    typedef adderRequest Request;
    typedef adderResponse Response;
  };
